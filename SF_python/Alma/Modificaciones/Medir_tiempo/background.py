...
#En esta parte se trataea de graficar con el factor de escala en lugar del logaritmo.
fact = np.exp(lna)

fig = plt.figure(figsize=(10,5))
ax3 = fig.add_subplot(111)

ax3.semilogx(fact, Y[2,:],label="$\Omega_b$")
ax3.semilogx(fact, Y[3,:],label="$\Omega_{dm}$")
ax3.semilogx(fact, Y[4,:],label="$\Omega_{\gamma}$")
ax3.semilogx(fact, Y[5,:],label="$\Omega_{\Lambda}$")
