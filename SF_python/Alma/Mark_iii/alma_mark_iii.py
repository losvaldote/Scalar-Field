...
ax3.semilogx(fact, om_phi, ls = 'dashed', label="$\omega (a)$")
...
ax3.semilogx(fact, om_phi2, ls = 'dotted', label="$\omega (a)2$")
...
ax3.semilogx(fact, om_phi3, label="$\omega (a)3$")
...
plt.xlim(1.0e-7,1)
#plt.ylim(-0.1,1.1)#Densidades
plt.ylim(-1.1,1.1)#Ecuacion de estado
